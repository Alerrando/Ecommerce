    ...
    <>
      <div className="grid grid-cols-projetos gap-14">
        {cardsInfo.map((card: CardKeys, index: number) => {
          return (
            <div className="max-w-[16.25rem] md:max-w-[20rem] h-[25rem] md:h-[20rem] relative mb-16 mx-auto text-center group border border-zinc-400 rounded-xl card-product" key={index}>
