  ...
  return (
    <section>
        ...
        <div className="grid gap-8 md:flex md:items-center justify-center md:gap-18 my-4 md:my-8">
            <div className="h-[4.6875rem] w-[12.5rem] md:h-[8.75rem] md:w-[15rem] mr-5">
                <img
            ...
            <div className="h-[6.25rem] w-[12.5rem] md:h-[8.75rem] md:w-[15.rem]">
                <img
            ...
            <div className="h-[7.5rem] w-[12.5rem] md:h-[10.625rem] md:w-[12.5rem]">
                <img
            ...
            <div className="h-[6.25rem] w-[11.875rem] md:h-[10.625rem] md:w-[12.5rem]">
                <img
            ...
            <div className="h-[7.8125rem] w-[12.5rem] md:h-[11.875rem] md:w-[13.75rem]">
                <img
